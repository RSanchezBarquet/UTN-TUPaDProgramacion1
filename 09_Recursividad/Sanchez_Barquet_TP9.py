...
numero = int(input("Ingrese un número entero positivo: "))
print("La serie de Fibonacci hasta la posición", numero, "es:")
...
4. Los restos obtenidos, leídos de abajo hacia arriba, forman el número binario.Convertir el número 10 a binario:
10 ÷ 2 = 5 resto: 0
5 ÷ 2 = 2 resto: 1
2 ÷ 2 = 1 resto: 0
1 ÷ 2 = 0 resto: 1
...
print(f"Se necesitan {total_bloques} bloques para construir toda la pirámide.")
